...
const TextFilter = ({ onTextFilterChange }: TextFilterProps) => {
  ...
  return (
    <div className="border rounded border-slate-500 py-2 pr-3 pl-10 relative lg:flex-1">
      ...
      <Input type="text" value={value} onChange={handleInputChange} placeholder="Job title, company or keyword" className="border-none focus-visible:ring-0 rounded-none" />
    </div>
  );
};
